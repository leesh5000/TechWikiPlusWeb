...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If login returns without error but no redirect (USER_PENDING case),
      // the auth-context already handled the redirect
    } catch (err: any) {
      // Only show error if it's not USER_PENDING (which is handled by redirect)
